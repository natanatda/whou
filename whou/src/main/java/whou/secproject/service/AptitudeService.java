...
public interface AptitudeService {
	...
	public void temporarySaveInsert(List<String> answers, AptitudeTestTemporarySaveDTO dto, String qnum, int userNum); // 임시
																														// 저장
...
//  public List<AptitudeTestTemporarySaveDTO> getTemporarySave(AptitudeTestTemporarySaveDTO dto, int userNum); //임시저장한 값
	...
	public void temporarySaveUpdate(List<String> answers, AptitudeTestTemporarySaveDTO dto, String qnum, int userNum); // 임시저장한
																														// 검사지를
																														// 다시
																														// 임시저장
