                ...
                <section class="py-5 disc-section" >
					<ul class="nav nav-underline tab" id="pills-tab" role="tablist">
						<li class="nav-item" role="presentation">						
							<button onclick="location='/whou/cs/faq'" class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true"><span>전체</span>보기</button></a>
						</li>
						<li class="nav-item" role="presentation">
