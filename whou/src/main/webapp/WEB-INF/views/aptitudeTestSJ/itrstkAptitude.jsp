							...
							<ul class="question-wrap">
								<c:forEach items="${RESULT}" var="item" varStatus="status">
									<li>
										...
										<div class="btn-group radio-group" role="group" aria-label="Basic radio toggle button group">
											<input type="radio" class="btn-check" name="btnradio${status.index+1}" id="btnradio${status.index * 4 + 1}" value="1" checked autocomplete="off">
											...
											<input type="radio" class="btn-check" name="btnradio${status.index+1}" id="btnradio${status.index * 4 + 3}" value="3" checked autocomplete="off">
								...
								<c:forEach items="${RESULT}" var="item" varStatus="status">
									<c:if test="${status.index+1 != 49}" >
										<li>
											...
											<div class="btn-group radio-group" role="group" aria-label="Basic radio toggle button group">
												<input type="radio" class="btn-check" name="btnradio${status.index+1}" id="btnradio${status.index * 5 + 1}" value="1" autocomplete="off">
												<label class="btn btn-outline-primary" for="btnradio${status.index * 5 + 1}">${item.answer01}</label>
												...
												<input type="radio" class="btn-check" name="btnradio${status.index+1}" id="btnradio${status.index * 5 + 5}" value="5" checked autocomplete="off">
												<label class="btn btn-outline-primary" for="btnradio${status.index * 5 + 5}">${item.answer05}</label>
											</div>
										</li>
									</c:if>
